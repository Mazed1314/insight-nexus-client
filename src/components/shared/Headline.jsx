...
const Headline = ({ title }) => {
  return (
    ...
    >
      <h1
        className="text-center my-4 text-xl md:text-3xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r 
                   from-purple-500 via-white to-teal-400 headline_font"
      >
        {title}
      </h1>
      <motion.div

...
const Contact = () => {
  return (
    <div>
      ...
      <section className="py-6 rounded-t-md text-gray-600 font-medium">
            ...
            <div className="space-y-4">
              <p className="flex items-center">
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  className="w-5 h-5 mr-2 text-teal-600 sm:mr-6"
                >
                  <path
                    fillRule="evenodd"
                ...
                <span>2312 GSE Street, Chittagong, Bangladesh</span>
              </p>
              <p className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  className="w-5 h-5 text-teal-600 mr-2 sm:mr-6"
                >
